...
#define CIRCLE_IN_ENCODER_THRE (15000)                      // 退出CIRCLE_IN1编码器阈值
#define CIRCLE_RUNNING_ENCODER_THRE (100000)                 // 退出CIRCLE_IN2编码器阈值
#define CIRCLE_OUT1_ENCODER_THRE (10000)                    // 退出CIRCLE_OUT2编码器阈值
